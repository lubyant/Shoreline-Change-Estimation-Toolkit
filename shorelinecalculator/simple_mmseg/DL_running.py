...
if __name__ == '__main__':
    ...
    parser.add_argument('-suffix', '--suffix', dest='suffix',
                        default='png', help='the suffix of img files')
    ...
    if os.path.isdir(args.input_img_path):
        process_img_folder(args.input_img_path, args.out_img_path,
                           args.config_file, args.checkpoint_file, img_suffix=args.suffix)
    elif os.path.isfile(args.input_img_path):
        process_single_img(args.input_img_path, args.out_img_path,
                           args.config_file, args.checkpoint_file, img_suffix=args.suffix)
