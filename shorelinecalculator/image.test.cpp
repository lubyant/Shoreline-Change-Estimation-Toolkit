...
BOOST_AUTO_TEST_CASE(test_overlaid){
    {
        ...
        image1.bottom_left_ = gm::Point<double>(0.5, 0);
        image1.bottom_right_ = gm::Point<double>(1, 0);
        image1.up_left_ = gm::Point<double>(0.5, 1);
        image1.up_right_ = gm::Point<double>(1, 1);
    ...
    }
    {
        ...
        image1.bottom_left_ = gm::Point<double>(1.5, 0);
        image1.bottom_right_ = gm::Point<double>(2, 0);
        image1.up_left_ = gm::Point<double>(1.5, 1);
        image1.up_right_ = gm::Point<double>(2, 1);
